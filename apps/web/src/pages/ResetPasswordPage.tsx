      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-base-200">
        ...
        <div className="relative w-full max-w-sm space-y-6">
          ...
          <div className="rounded-2xl bg-base-100 border border-base-300 shadow-xl p-6 lg:p-8">
            <div className="mb-6">
              <h2 className="text-xl font-bold">{t('auth.forgotPasswordTitle')}</h2>
              <p className="text-base-content/50 text-sm mt-1">{t('auth.enterNewPassword')}</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <fieldset className="fieldset">
                <legend className="fieldset-legend text-xs">{t('auth.newPassword')}</legend>
                <input
                  type="password"
                  value={password}
            ...
            <div className="flex flex-col gap-2 text-center text-sm">
              ...
              <Link to="/login" className="link link-ghost text-base-content/50">
                {t('auth.backToLogin')}
              </Link>
            </div>
          </div>
