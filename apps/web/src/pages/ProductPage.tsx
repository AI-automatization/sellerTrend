        ...
        <div className="rounded-2xl bg-base-200/60 border border-primary/20 p-4 lg:p-6 space-y-4">
          ...
          <div className="flex items-center justify-between gap-2 flex-wrap">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-base">Claude AI Tahlili</h2>
            </div>
          ...
          {aiLoading && !trendAnalysis ? (
            ...
            <div className="space-y-3">
              ...
              <div className="bg-primary/10 border border-primary/30 rounded-xl px-4 py-3">
                <p className="text-sm font-semibold text-base-content leading-relaxed">{trendAnalysis.analysis}</p>
              </div>
              ...
              {trendAnalysis.factors.length > 0 && (
                <div className="space-y-2">
                  {trendAnalysis.factors.map((f, i) => (
                    <div key={i} className="flex items-center gap-3 bg-base-100/80 border border-base-300/60 rounded-xl px-3 py-2.5">
                      <span className="w-6 h-6 rounded-full bg-primary text-primary-content text-xs font-bold flex items-center justify-center shrink-0">
                        {i + 1}
                      </span>
                      <span className="text-sm text-base-content font-medium">{f}</span>
                    </div>
                  ))}
                </div>
              )}

              {/* Recommendation — green solid card */}
              {trendAnalysis.recommendation && (
                <div className="bg-success/15 border border-success/40 rounded-xl px-4 py-3 flex gap-2.5">
                  <span className="text-base shrink-0">💡</span>
                  <div>
                    <p className="text-xs font-bold text-success mb-1">Tavsiya</p>
                    <p className="text-sm text-base-content font-medium leading-relaxed">{trendAnalysis.recommendation}</p>
                  </div>
                </div>
              )}
            </div>
