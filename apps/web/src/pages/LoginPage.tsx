...
export function LoginPage() {
  ...
  useEffect(() => {
    const t1 = setTimeout(() => setPhase(1), 600);   // logo chapga, text o'ngdan
    const t2 = setTimeout(() => setPhase(2), 1300);  // content fade in
    const t3 = setTimeout(() => setPhase(3), 1800);  // overlay yashiriladi
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-base-200">
      ...
      <div className="absolute -bottom-32 -right-32 w-[30rem] h-[30rem] rounded-full bg-primary/3 blur-3xl pointer-events-none" />

      {/* Intro overlay */}
      <div
        className="fixed inset-0 z-30 flex items-center justify-center bg-base-200"
        style={{
          opacity: phase < 3 ? 1 : 0,
      ...
      >
        {/* Logo markazda, text chiqgach ikkalasi markazda qoladi */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          {/* Logo — text kengligining yarmiga chapga siljiydi, keyin qaytadi */}
          <img
            src="/rift-logo.svg"
            alt="RIFT"
          ...
          {/* Text — logo ortidan o'ngga chiqib keladi */}
          <div style={{ overflow: 'hidden' }}>
            <div
              style={{
                transform: phase >= 1 ? 'translateX(0)' : 'translateX(-110%)',
                opacity: phase >= 1 ? 1 : 0,
                transition: 'transform 0.6s cubic-bezier(0.4, 0, 0.2, 1) 0.1s, opacity 0.3s ease 0.1s',
                whiteSpace: 'nowrap',
                paddingLeft: '12px',
              }}
            >
              <h1 className="text-4xl font-black tracking-tight font-heading text-primary">RIFT</h1>
      ...
      <div className="min-h-screen flex">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12">
          <div className="relative z-10 max-w-md space-y-8">
            ...
            >
              <img src="/rift-logo.svg" alt="RIFT" className="w-14 h-14 shrink-0" />
              <div>
                <h1 className="text-3xl font-black tracking-tight font-heading text-primary">RIFT</h1>
                <p className="text-base-content/40 text-sm">Analytics Platform</p>
              </div>
            </div>
            ...
            <div className="space-y-5">
              {features.map((f, i) => (
                <div
                  key={f.title}
                  className="flex items-start gap-4 p-4 rounded-xl bg-base-200/30 border border-base-300/20 backdrop-blur-sm"
                  style={{
                    opacity: phase >= 2 ? 1 : 0,
            ...
            <p
              className="text-xs text-base-content/25"
              style={{
                opacity: phase >= 2 ? 1 : 0,
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="flex flex-col items-center lg:hidden mb-4">
              ...
              <h1 className="text-2xl font-black font-heading tracking-tight text-primary">RIFT</h1>
              <p className="text-base-content/40 text-sm">Analytics Platform</p>
            </div>
