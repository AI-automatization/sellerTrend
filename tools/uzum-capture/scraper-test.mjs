...
async function main() {
  ...
  console.log('Waiting for Vue app to render products (8 sec)...');
  ...
  if (!foundSelector) {
    ...
    writeFileSync('uzum-rendered.html', html);
    console.log('Saved rendered HTML to uzum-rendered.html (', html.length, 'chars)');
  ...
  await page.screenshot({ path: 'uzum-screenshot.png', fullPage: false });
  console.log('\nScreenshot saved to uzum-screenshot.png');
